...
const cacheName = 'A2JacobStraub-2021-02-28 22:13:31.184980'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A2JacobStraub'.length) === 'A2JacobStraub') {
